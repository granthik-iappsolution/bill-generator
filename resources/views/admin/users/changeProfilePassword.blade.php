...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            {!! html()->form('POST', route('admin.users.profile.changePassword.process', \Auth::user()))
                ->class('submitsByAjax')
                ->acceptsFiles()
                ->open() !!}
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-4">
                        <div class="form-password-toggle">
                            {!! html()->label('Existing Password:', 'existing_password')->class('form-label') !!}
                            <div class="input-group input-group-merge">
                                {!! html()->password('existing_password')
                                    ->class('form-control')
                                    ->placeholder('Existing password of the user')
                                !!}
